...
<body x-data="{ active: 2 }" class="antialiased scroll-smooth">
    ...
    <section x-show="active == 2" x-transition:enter="transition ease-in-out duration-1000"
        ...
        <div class="flex-grow overflow-y-auto p-3">
            <section id="jadwal">
                <div class=" border border-slate-200 shadow-sm shadow-pink-700 backdrop-blur bg-white/80 rounded-lg flex flex-col justify-center items-center">
                    <div>
                        <img src="{{ asset('images/male.png') }}" alt="pria" class=" rounded-full w-32 h-32">
                    </div>
                </div>
            </section>
